...
-  (void)button1Click:(id)sender
{
    ...
    [self performSelector:@selector(buttonAppear:) withObject:button1 afterDelay:3.0];
}
...
-  (void)button2Click:(id)sender
{
    if ((button1.hidden==YES)) {
        ...
        [self performSelector:@selector(buttonAppear:) withObject:button2 afterDelay:3.0];
    }
    else  {
...
-  (void)button3Click:(id)sender
{
    if ((button1.hidden==YES) && (button2.hidden==YES))  {
        ...
        [self performSelector:@selector(buttonAppear:) withObject:button3 afterDelay:3.0];
    }
    else  {
        [button1 setHidden:NO];
        [button2 setHidden:NO];
...
-  (void)button4Click:(id)sender
{
    if ((button1.hidden==YES) && (button2.hidden==YES) && (button3.hidden==YES))  {
        ...
        [self performSelector:@selector(buttonAppear:) withObject:button4 afterDelay:3.0];
    }
    else  {
        [button1 setHidden:NO];
        [button2 setHidden:NO];
...
-  (void)button5Click:(id)sender
{
    if ((button1.hidden==YES) && (button2.hidden==YES) && (button3.hidden==YES) && (button4.hidden==YES))  {
        ...
        [self performSelector:@selector(buttonAppear:) withObject:button5 afterDelay:3.0];
    }
    else  {
        [button1 setHidden:NO];
        [button2 setHidden:NO];
...
-  (void)button6Click:(id)sender
{
    if ((button1.hidden==YES) && (button2.hidden==YES) && (button3.hidden==YES) && (button4.hidden==YES) && (button5.hidden==YES))  {
        ...
        [self performSelector:@selector(buttonAppear:) withObject:button6 afterDelay:3.0];
    }
    else  {
        [button1 setHidden:NO];
        [button2 setHidden:NO];
